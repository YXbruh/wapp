...
{
    public partial class Lecturer_Profile : Page
    {
        ...
        private void LoadProfile()
        {
            ...
            tbEmail.Text = Convert.ToString(row["Email"]);
            tbPhone.Text = row["PhoneNumber"] == DBNull.Value ? "" : Convert.ToString(row["PhoneNumber"]);
            tbDepartment.Text = row["Department"] == DBNull.Value ? "" : Convert.ToString(row["Department"]);
