...
CREATE TABLE VirtualLabs (
    ...
    Scenario        NVARCHAR(MAX)  NULL,        -- step-by-step instructions
    HintText        NVARCHAR(2000) NULL,
    ExpectedCommand NVARCHAR(2000) NOT NULL,    -- string the system compares against student input
    Difficulty      NVARCHAR(20)   NOT NULL DEFAULT 'Easy',  -- Easy / Medium / Hard
